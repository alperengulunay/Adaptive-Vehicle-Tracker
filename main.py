...
OBJECT_CLOSER_RATIO_HEIGHT = 0.45
OBJECT_CLOSER_RATIO_WIDTH = 0.80 
POSITIVE_RESULTS_FOR_VERIFICATION = 5
YOLO_DETECTION_CONFIDENT = 0.60
TRACK_START_FRAME_RATE = 0.60 * VIDEO_WIDTH
TRACKING_FRAME_SKIP = 1
WHEEL_POSITION_RANGE_START = int(0.65 * VIDEO_HEIGHT)
WHEEL_POSITION_RANGE_END = int(0.90 * VIDEO_HEIGHT)
VALIDATION_TREMOR_THRESHOLD = 20 
IRREGULAR_THRESHOLD = 40
ACCEPT_THAT_THE_WHEEL_MOVES_PIXEL = 15
PHOTO_CAPTURED_IN_PIXEL_CHANGE = 75
VALID_DURATION = 10
WHEEL_OUT_OF_FRAME_RATE = 0.95 * VIDEO_WIDTH
TRUCK_OUT_OF_FRAME_VERIFICATION_THRESHOLD = 100
TRUCK_LEFT_THRESHOLD = 100
...
frame_skip = 6 #  of frames to be skippedNumber in each loop (for high-performance operation during non-truck times)
frame_count = 0
                ...
                if valid_circles:
                    ...
                    if not valid_circles:
                        ...
                        if truck_left_counter >= TRUCK_LEFT_THRESHOLD:
                            ...
                            for i, foto in enumerate(imgs_reverse):
                                cv2.imwrite(str(i) + '.jpg', foto)
